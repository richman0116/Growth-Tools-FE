  ...
  ({ className, type, prefix, suffix, ...props }, ref) => {
    return (
      <div className="flex items-center relative">
        {prefix && (
          <span className="border-r left-0 absolute w-16 h-full flex items-center justify-center font-bold text-[#8C8C8C] text-base">
            {prefix}
          </span>
        )}
        <input
        ...
        />
        {suffix && (
          <span className="border-l right-0 absolute w-16 h-full flex items-center justify-center font-bold text-[#8C8C8C] text-base">
            {suffix}
          </span>
        )}
      </div>
